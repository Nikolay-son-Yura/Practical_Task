...
// *(HARD) Не обязательно! Реализовать алгоритм пирамидальной сортировки (HeapSort). Делайте по желанию.
// Это не мое решение скачал, чтобы разобраться
...
public class Task5_3 {
    ...
    public static void printArr() {
        int[] newArr = {12, 6, 4, 1, 15, 10};
        System.out.println("Не отсортированный массив " + Arrays.toString(newArr));
        int[] sortArr = heapSort(newArr);
